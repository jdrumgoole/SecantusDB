...
Generated 2026-09-07 — SecantusDB 0.6.0b16 vs mongo-csharp-driver 8297e62 (`vendor/mongo-csharp-driver/`).
...
| `MongoDB.Driver.Tests.Specifications.crud.prose_tests` | 10 | 22 | 0 | 32 | 31.2% |
| **Overall** | **206** | **22** | **0** | **228** | **90.4%** |
...
```
MongoDB.Driver.Tests.Specifications.crud.prose_tests.CrudProseTests.Ensure_generated_ids_are_first_fields_in_document_using_collection_bulkWrite(async: False)
...
MongoDB.Driver.Tests.Specifications.crud.prose_tests.CrudProseTests.Ensure_generated_ids_are_first_fields_in_document_using_collection_bulkWrite(async: True)
...
MongoDB.Driver.Tests.Specifications.crud.prose_tests.CrudProseTests.MongoClient_bulkWrite_unacknowledged_write_concern_uses_w0_all_batches(async: False)
