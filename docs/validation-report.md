...
Generated 2026-08-10 — SecantusDB 0.6.0b9 vs pymongo f2103a95870a (`vendor/pymongo-tests/`).
...
| **Overall** | **1017** | **8** | **0** | **475** | **1500** | **99.2%** |
...
```
vendor/pymongo-tests/test/test_bulk.py::TestBulk::test_multiple_error_unordered_batch
vendor/pymongo-tests/test/test_bulk.py::TestBulk::test_single_error_ordered_batch
vendor/pymongo-tests/test/test_bulk.py::TestBulk::test_single_error_unordered_batch
