...
Generated 2026-09-07 — SecantusDB 0.6.0b16 vs mongo-rust-driver 12dd49b (`vendor/mongo-rust-driver/`).
...
test::coll::find_one_and_delete_hint_server_version
    thread 'test::coll::find_one_and_delete_hint_server_version' (10429) panicked at driver/src/test/coll.rs:663:9:
test::spec::crud::generated_id_first_field
    thread 'test::spec::crud::generated_id_first_field' (11061) panicked at driver/src/test/spec/crud.rs:68:53:
test::spec::crud::run_unified
    thread 'test::spec::crud::run_unified' (11076) panicked at driver/src/test/spec/unified_runner/operation.rs:202:29:
```
