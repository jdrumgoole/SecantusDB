...
Generated 2026-06-14 — SecantusDB 0.5.3b1 vs pymongo f2103a95870a (`vendor/pymongo-tests/`).
...
| `test_crud_unified.py` | 275 | 26 | 0 | 185 | 486 | 91.4% |
...
| **Overall** | **872** | **156** | **0** | **475** | **1503** | **84.8%** |
