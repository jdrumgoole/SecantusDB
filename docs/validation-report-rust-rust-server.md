...
Generated 2026-09-21 — SecantusDB 0.6.0b16 vs mongo-rust-driver 12dd49b (`vendor/mongo-rust-driver/`).
...
test::coll::find_one_and_delete_hint_server_version
    thread 'test::coll::find_one_and_delete_hint_server_version' (16279) panicked at driver/src/test/coll.rs:663:9:
```
