...
scales **monotonically** — ~1.5× at two writers, ~2.3× at four, ~2.7×
...
both fixed). The remaining gap to mongod's ~4.6× is a **WiredTiger**
...
<div class="dviz-wrap"><div class="dv-legend"><span><span class="chip" style="background:var(--dv-mongo)"></span>mongod</span><span><span class="chip" style="background:var(--dv-rust)"></span>Rust server</span><span><span class="chip" style="background:var(--dv-py)"></span>Python server</span><span><span class="chip" style="background:transparent;border:2px dashed var(--dv-rust);box-sizing:border-box"></span>Rust server — async stack</span></div><svg viewBox="0 0 790 320" role="img" aria-label="Throughput scaling relative to each server single-writer rate" class="dviz"><line x1="56" y1="214" x2="668" y2="214" class="dv-ref"/><text x="48" y="218" text-anchor="end" class="dv-tick">1<tspan class="dv-x">x</tspan></text><line x1="56" y1="160" x2="668" y2="160" class="dv-grid"/><text x="48" y="164" text-anchor="end" class="dv-tick">2<tspan class="dv-x">x</tspan></text><line x1="56" y1="105" x2="668" y2="105" class="dv-grid"/><text x="48" y="109" text-anchor="end" class="dv-tick">3<tspan class="dv-x">x</tspan></text><line x1="56" y1="51" x2="668" y2="51" class="dv-grid"/><text x="48" y="55" text-anchor="end" class="dv-tick">4<tspan class="dv-x">x</tspan></text><text x="56" y="290" text-anchor="middle" class="dv-tick">1</text><text x="143" y="290" text-anchor="middle" class="dv-tick">2</text><text x="318" y="290" text-anchor="middle" class="dv-tick">4</text><text x="668" y="290" text-anchor="middle" class="dv-tick">8</text><text x="362" y="310" text-anchor="middle" class="dv-lab">concurrent writers</text><path d="M56.0,214.0 L143.4,163.8 L318.3,80.1 L668.0,21.0" fill="none" stroke="var(--dv-mongo)" stroke-width="2"/><circle cx="56.0" cy="214.0" r="4.5" fill="var(--dv-mongo)"><title>mongod — 1 writer: 1.00x its single-writer rate</title></circle><circle cx="143.4" cy="163.8" r="4.5" fill="var(--dv-mongo)"><title>mongod — 2 writers: 1.92x its single-writer rate</title></circle><circle cx="318.3" cy="80.1" r="4.5" fill="var(--dv-mongo)"><title>mongod — 4 writers: 3.46x its single-writer rate</title></circle><circle cx="668.0" cy="21.0" r="4.5" fill="var(--dv-mongo)"><title>mongod — 8 writers: 4.55x its single-writer rate</title></circle><path d="M56.0,214.0 L143.4,185.9 L318.3,145.2 L668.0,120.3" fill="none" stroke="var(--dv-rust)" stroke-width="2"/><circle cx="56.0" cy="214.0" r="4.5" fill="var(--dv-rust)"><title>Rust server — 1 writer: 1.00x its single-writer rate</title></circle><circle cx="143.4" cy="185.9" r="4.5" fill="var(--dv-rust)"><title>Rust server — 2 writers: 1.52x its single-writer rate</title></circle><circle cx="318.3" cy="145.2" r="4.5" fill="var(--dv-rust)"><title>Rust server — 4 writers: 2.27x its single-writer rate</title></circle><circle cx="668.0" cy="120.3" r="4.5" fill="var(--dv-rust)"><title>Rust server — 8 writers: 2.72x its single-writer rate</title></circle><path d="M56.0,214.0 L143.4,228.4 L318.3,221.6 L668.0,234.2" fill="none" stroke="var(--dv-py)" stroke-width="2"/><circle cx="56.0" cy="214.0" r="4.5" fill="var(--dv-py)"><title>Python server — 1 writer: 1.00x its single-writer rate</title></circle><circle cx="143.4" cy="228.4" r="4.5" fill="var(--dv-py)"><title>Python server — 2 writers: 0.74x its single-writer rate</title></circle><circle cx="318.3" cy="221.6" r="4.5" fill="var(--dv-py)"><title>Python server — 4 writers: 0.86x its single-writer rate</title></circle><circle cx="668.0" cy="234.2" r="4.5" fill="var(--dv-py)"><title>Python server — 8 writers: 0.63x its single-writer rate</title></circle><path d="M56.0,214.0 L143.4,197.2 L318.3,160.2 L668.0,139.8" fill="none" stroke="var(--dv-rust)" stroke-width="2" stroke-dasharray="6 4"/><circle cx="56.0" cy="214.0" r="4.5" fill="var(--dv-rust)"><title>Rust server (async + non-logged oplog) — 1 writer: 1.00x its single-writer rate</title></circle><circle cx="143.4" cy="197.2" r="4.5" fill="var(--dv-rust)"><title>Rust server (async + non-logged oplog) — 2 writers: 1.31x its single-writer rate</title></circle><circle cx="318.3" cy="160.2" r="4.5" fill="var(--dv-rust)"><title>Rust server (async + non-logged oplog) — 4 writers: 1.99x its single-writer rate</title></circle><circle cx="668.0" cy="139.8" r="4.5" fill="var(--dv-rust)"><title>Rust server (async + non-logged oplog) — 8 writers: 2.37x its single-writer rate</title></circle><text x="674" y="25" class="dv-val" fill="var(--dv-mongo)">mongod 4.6<tspan class="dv-x">x</tspan></text><text x="674" y="124" class="dv-val" fill="var(--dv-rust)">Rust 2.7<tspan class="dv-x">x</tspan></text><text x="674" y="238" class="dv-val" fill="var(--dv-py)">Python 0.6<tspan class="dv-x">x</tspan></text><text x="674" y="144" class="dv-val" fill="var(--dv-rust)">async 2.4<tspan class="dv-x">x</tspan></text></svg></div>
<!-- concurrency-viz:end -->
```
...
|---|---:|---:|---:|---:|
| 1 | 12,100 | 35,400 | 50,400 | 105,700 |
| 2 | 8,900 | 53,700 | 66,000 | 203,300 |
...
- **The Rust server now scales monotonically** — 1.5× at two writers,
  2.3× at four, **2.7× at eight**, with no cliff. The earlier
