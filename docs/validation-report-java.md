...
Generated 2026-05-11 — SecantusDB 0.5.0b9 vs mongo-java-driver cb45be6bb147 (`vendor/mongo-java-driver/`).
...
| `driver-sync` | 354 | 0 | 310 | 664 | 100.0% |
| **Overall** | **4163** | **0** | **321** | **4484** | **100.0%** |
