...
| `agg_expressions.py` | every aggregation EXPRESSION operator (143), 1- and 2-argument forms | first run 2026-08-31: **3884 cases, 57 wrong values, 2288 different codes, 689 message-only, 274 crashes**. The wrong-answer half is fixed; the arity / Decimal128 / coercion families are **open** — see `tasks/backlog.md` §5 |
