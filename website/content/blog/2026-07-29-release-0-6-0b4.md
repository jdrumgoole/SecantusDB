Title: Restore full PGO on the arm64-macOS standalone binary
Date: 2026-07-29 12:00:00
Slug: release-0-6-0b4
...
[Full release notes on GitHub](https://github.com/jdrumgoole/SecantusDB/releases/tag/v0.6.0b4) ·
[Install from PyPI](https://pypi.org/project/SecantusDB/0.6.0b4/) ·
[Tag](https://github.com/jdrumgoole/SecantusDB/tree/v0.6.0b4)
